<div class="kt-section__body">
  ...
  <div class="form-group row">
    <label class="col-lg-3 col-form-label"> Relation From Multi </label>
    <div class="col-lg-9">
      {!! Form::select('id_multi_relation', dummy_table_multi_relations(), (isset($data->id_multi_relation) ? $data->id_multi_relation : NULL), ['placeholder' => '- Select Relation From Multi -', 'class' => 'form-control', 'required' => 'required']) !!}
      @error('id_multi_relation') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
    </div>
  </div>
