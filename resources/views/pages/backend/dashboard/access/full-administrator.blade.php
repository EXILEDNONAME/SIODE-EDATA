  ...
  <div class="col-md-3">
    <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
      ...
      <div class="alert-text">
        ...
        <a href="/dashboard/management/accesses" class="text-danger"> {{ DB::table('accesses')->get()->count() }} </a> Accesses
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card card-custom gutter-b" data-card="true" id="kt_card_3">
      ...
      <div class="card-header">
        <div class="card-title">
          <h3 class="card-label"> Monitoring Rumah Dinas </h3>
        </div>

        <div class="card-toolbar">
          <a id="jm-official-file-refresh" class="btn btn-sm btn-icon btn-clean btn-icon-md"  data-toggle="tooltip" title="{{ trans('default.label.refresh') }}"><i class="la la-refresh"></i></a>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table width="100%" class="table table-striped-table-bordered table-hover table-checkable" id="exilednoname_monitoring_officials">
            <thead>
              <tr>
...
var KTDatatablesExtensionsKeytable = function() {
  ...
  var initTable1 = function() {
    var table = $('#exilednoname_monitoring_officials').DataTable({
      processing: true,
      serverSide: true,
      searching: true,
      rowId: 'id',
      select: { style: 'multi', selector: 'td:first-child .checkable', },
      ajax: { url: "/dashboard/jasamarga/monitorings", },
    ...
    $("#jm-official-file-refresh").on("click", function() { table.ajax.reload(); });
    $('#jm_official_export_print').on('click', function(e) { e.preventDefault(); table.button(0).trigger(); });
    $('#jm_official_export_copy').on('click', function(e) { e.preventDefault(); table.button(1).trigger(); });
    $('#jm_official_export_excel').on('click', function(e) { e.preventDefault(); table.button(2).trigger(); });
    $('#jm_official_export_csv').on('click', function(e) { e.preventDefault(); table.button(3).trigger(); });
    $('#jm_official_export_pdf').on('click', function(e) { e.preventDefault(); table.button(4).trigger(); });
    $('#jm_official_export_selected_pdf').on('click', function(e) { e.preventDefault(); table.button(5).trigger(); });
    $('#jm_official_export_selected_excel').on('click', function(e) { e.preventDefault(); table.button(6).trigger(); });
    $('#jm_official_export_selected_copy').on('click', function(e) { e.preventDefault(); table.button(7).trigger(); });
    $('#jm_official_export_selected_print').on('click', function(e) { e.preventDefault(); table.button(8).trigger(); });
